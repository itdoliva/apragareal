      ...
      <div className="double-column intro">
        ...
        <div className="column">
          ...
          <div className="text-block">
           ...
           <p>Os impactos dos agrotóxicos também se alastram por toda a complexa cadeia da qual a espécie inicialmente acometida participa. Como uma praga silenciosa, o envenenamento é disseminado e toma enormes proporções. Lentamente, a raça humana se coloca na mira do próprio gatilho.</p>
          </div>
        </div>
